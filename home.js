...
var IMG_HERO    = "https://ik.imagekit.io/megharaj/Menswear/IMG_9398.JPG.jpeg?tr=w-1000,q-92,f-auto"; // SS25 hero

const HOME_HTML = `
  <style>
    /* ═══ HERO IMAGE — fit cleanly, no harsh crop ═══ */
    .ed-hero-arch{overflow:hidden}
    .ed-hero-arch img{width:100%;height:100%;object-fit:cover;object-position:35% 25%;border-radius:inherit;display:block}
