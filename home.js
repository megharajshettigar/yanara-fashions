...
@media(max-width:850px){
  .ed-hero-arch img{object-position:center top}
   ...
   .ed-stack-item{display:block;background:var(--bg);
    ...
    @media (max-width:768px){
      ...
      .ed-cat-img{position:relative!important;height:190px!important;opacity:1!important}
      ...
      .ed-cat-open .cb{font-size:9px!important}
      .ed-cat-num{position:static!important;top:auto!important;right:auto!important;left:auto!important;padding:10px 12px 0!important}
      /* Featured: stack */
  ...
  <section class="ed-stack-item ed-cats" style="position:relative">
    ...
    <div class="ed-cat-row ed-cat-panel" data-panel="men">
      <div class="ed-cat" onclick="shopCat('Blazers')">
      ...
      <div class="ed-cat" onclick="shopCat('Jodhpuri Bandhgala')">
      ...
      <div class="ed-cat" onclick="shopCat('Indo Western')">
  ...
  <footer>
    <div class="fgrid2">
      ...
      <div><div class="ft">Categories</div><ul class="flinks"><li><a onclick="shopCat('Blazers')">Blazer Sets</a></li><li><a onclick="shopCat('Jodhpuri Bandhgala')">Bandhgala Sets</a></li><li><a onclick="shopCat('Indo Western')">Indo Western</a></li><li><a onclick="shopCat('Shirts')">Hand Painted Shirts</a></li><li><a onclick="go('shop')">View All</a></li></ul></div>
