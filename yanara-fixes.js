// --- YANARA COMPONENT LOADER ---
// This function acts like a "delivery driver." 
// It goes to the folder, picks up the HTML, and delivers it to the page.

async function loadComponent(elementId, filePath) {
    const element = document.getElementById(elementId);
    if (element) {
        try {
            // 'fetch' is the command to go get the file
            ...
            // Put that text inside the "placeholder" on the page
...
// This tells the browser: "As soon as the page is finished loading, 
// go get the header and footer immediately."
