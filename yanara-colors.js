...
// --- NEW: PRODUCT DETAIL IMAGE SWAPPER ---
// This function runs when you click a color circle on the Detail Page.
function changeProductColor(productCode, colorName) {
    const mainImg = document.getElementById('main-product-img');
    const nameHeader = document.getElementById('p-name');
    
    if (mainImg) {
        // Deep Logic: We assume your images are named 'CODE_COLOR.jpg'
        // Example: BZ01_Black.jpg
        mainImg.src = `images/${productCode}_${colorName}.jpg`;
        mainImg.alt = `${colorName} variant`;
        
        // Update the text so the user knows which color is selected
        console.log("Switched to color: " + colorName);
    }
}
