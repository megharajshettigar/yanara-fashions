...
var DESIGNER_PHOTO = "https://ik.imagekit.io/megharaj/DESIGNER%20PHOTO/artist_image_white_BC.png?tr=w-1600,q-85,f-auto&v=2"; // empty = shows an elegant placeholder
  ...
  <div class="dz-wrap">
    ...
    <div class="dz-cta dz-rev">
      ...
      <div class="dz-cta-row">
        ...
        <a class="dz-btn-ghost" href="https://www.instagram.com/ramya_._n?igsh=MTU2dTFyaHFyZ2tlOA%3D%3D&utm_source=qr" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;text-decoration:none"><i class="ti ti-brand-instagram"></i> Follow Ramya</a>
      </div>
    </div>
