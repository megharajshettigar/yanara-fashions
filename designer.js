...
var DESIGNER_PHOTO = "https://ik.imagekit.io/megharaj/RAMYA%20-%20.png"; // empty = shows an elegant placeholder
...
var DESIGNER_HTML = `
  <style>
    ...
    .dz-hero{position:sticky;top:0;height:100vh;min-height:560px;overflow:hidden;
      display:flex;align-items:center;justify-content:center;z-index:0;background:#eceae6}
    /* Chylak-style: photo CENTERED with whitespace, not full-bleed */
    .dz-hero-img{max-width:46%;max-height:84vh;width:auto;height:auto;object-fit:contain}
    .dz-hero-ph{width:42%;height:70vh;display:flex;align-items:center;justify-content:center;
      background:#e2dfd9}
    .dz-hero-ph i{font-size:80px;color:#b3a98f}
    .dz-scroll-hint{position:absolute;bottom:26px;left:50%;transform:translateX(-50%);z-index:3;
      font-size:22px;color:#888;animation:dzBounce 1.8s ease-in-out infinite}
  ...
  <div class="dz-wrap">
    ...
    <!-- HERO: clean centered designer photo, no text (Chylak-style) -->
    <div class="dz-hero">
      ${DESIGNER_PHOTO
