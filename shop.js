...
const IK_TR_CARD   = "tr=w-700,q-85,f-auto";
...
const products=[
  {id:1,code:"BZ01BL",name:"Black Draped Collar Blazer Set",cat:"Blazer Sets",price:24900,sizes:["S","M","L","XL"],badge:"Featured",imgs:imgUrls("BZ01BL",5),desc:"Elegant black blazer with draped collar detailing. Perfect for wedding receptions and evening events."},
  {id:2,code:"BZ02MR",name:"Maroon Zari Embroidery Blazer Set",cat:"Blazer Sets",price:28900,sizes:["S","M","L","XL","XXL"],badge:"New",imgs:imgUrls("BZ02MR",5),desc:"Rich maroon blazer with traditional Zari embroidery. A classic choice for wedding ceremonies."},
  {id:3,code:"BZ05BL",name:"Black Cutdana Work Blazer Set",cat:"Blazer Sets",price:26500,sizes:["M","L","XL"],imgs:imgUrls("BZ05BL",4),desc:"Premium black blazer with intricate Cutdana embellishments."},
  {id:4,code:"BZ06DB",name:"Dark Blue Sequin Blazer Set",cat:"Blazer Sets",price:27900,sizes:["S","M","L","XL"],imgs:imgUrls("BZ06DB",4),desc:"Deep blue blazer with shimmering sequin work for a festive look."},
  {id:5,code:"BZ07WI",name:"Wine Velvet Blazer Set",cat:"Blazer Sets",price:31900,sizes:["M","L","XL","XXL"],imgs:imgUrls("BZ07WI",4),desc:"Luxurious wine-coloured velvet blazer. Exudes old-world charm."},
  {id:6,code:"BZ08GY",name:"Grey Structured Blazer Set",cat:"Blazer Sets",price:22900,sizes:["S","M","L","XL"],imgs:imgUrls("BZ08GY",4),desc:"Classic grey blazer with structured shoulders. Versatile for all occasions."},
  {id:7,code:"BZ09DG",name:"Dark Green Zari Blazer Set",cat:"Blazer Sets",price:29500,sizes:["M","L","XL"],imgs:imgUrls("BZ09DG",4),desc:"Deep forest green with Zari border detailing. Perfect for festive celebrations."},
  {id:8,code:"BZ10BL",name:"Hand Painted Art Blazer Set",cat:"Blazer Sets",price:38900,sizes:["S","M","L","XL"],imgs:imgUrls("BZ10BL",7),desc:"One-of-a-kind hand painted blazer. Wearable art by designer Ramya."},
  {id:9,code:"BZ12OP",name:"Onion Pink Embroidered Blazer Set",cat:"Blazer Sets",price:25900,sizes:["S","M","L","XL"],imgs:imgUrls("BZ12OP",4),desc:"Soft onion pink with delicate embroidery — a contemporary take on ethnic wear."},
  {id:10,code:"BG01BL",name:"Black Classic Bandhgala Set",cat:"Bandhgala Sets",price:29000,sizes:["38","40","42","44"],imgs:imgUrls("BG01BL",5),desc:"Timeless black Bandhgala with clean lines. The perfect formal ethnic suit."},
  {id:11,code:"BG05BL",name:"Black Bandhgala Set",cat:"Bandhgala Sets",price:32000,sizes:["38","40","42","44","46"],imgs:imgUrls("BG05BL",5),desc:"Navy blue Bandhgala with subtle gold embroidery along the collar and buttons."},
  {id:12,code:"BG06MR",name:"Maroon Bandhgala Set",cat:"Bandhgala Sets",price:34500,sizes:["38","40","42"],imgs:imgUrls("BG06MR",5),desc:"Ivory cream silk Bandhgala — luxurious and understated elegance."},
  {id:13,code:"BG09NB",name:"Navy Blue Bandhgala Set",cat:"Bandhgala Sets",price:36900,sizes:["38","40","42","44"],imgs:imgUrls("BG09NB",5),desc:"Royal maroon velvet Bandhgala — perfect for winter weddings."},
  {id:14,code:"BG10BL",name:"Black Velvet Bandhgala Set",cat:"Bandhgala Sets",price:36900,sizes:["38","40","42","44"],imgs:imgUrls("BG10BL",4),desc:"Black velvet Bandhgala — timeless and sophisticated."},
  {id:15,code:"BG13BL",name:"Black Embroidered Bandhgala Set",cat:"Bandhgala Sets",price:38000,sizes:["38","40","42","44"],imgs:imgUrls("BG13BL",5),desc:"Black Bandhgala with intricate embroidery detailing."},
  {id:16,code:"BG14DB",name:"Dark Blue Bandhgala Set",cat:"Bandhgala Sets",price:38000,sizes:["38","40","42","44"],imgs:imgUrls("BG14DB",5),desc:"Deep blue Bandhgala with refined craftsmanship."},
  {id:17,code:"BG15PK",name:"Pink Bandhgala Set",cat:"Bandhgala Sets",price:38000,sizes:["38","40","42","44"],imgs:imgUrls("BG15PK",5),desc:"Elegant pink Bandhgala for festive celebrations."},
  {id:18,code:"BG16GY",name:"Grey Bandhgala Set",cat:"Bandhgala Sets",price:38000,sizes:["38","40","42","44"],imgs:imgUrls("BG16GY",5),desc:"Sophisticated grey Bandhgala — perfect for receptions."},
  {id:19,code:"BG17WI",name:"Wine Bandhgala Set",cat:"Bandhgala Sets",price:38000,sizes:["38","40","42","44"],imgs:imgUrls("BG17WI",5),desc:"Rich wine Bandhgala with premium fabric and finish."},
  {id:20,code:"BG19WI",name:"Wine Classic Bandhgala Set",cat:"Bandhgala Sets",price:31000,sizes:["38","40","42","44"],imgs:imgUrls("BG19WI",6),desc:"Classic wine Bandhgala — elegant and timeless."},
  {id:21,code:"BG20PC",name:"Peach Bandhgala Set",cat:"Bandhgala Sets",price:31000,sizes:["38","40","42","44"],imgs:imgUrls("BG20PC",1),desc:"Soft peach Bandhgala — a fresh and modern take on ethnic wear."},
  {id:22,code:"IW01BL",name:"Black Indo Western Co-ord Set",cat:"Indo Western Sets",price:21900,sizes:["S","M","L","XL"],imgs:imgUrls("IW01BL",7),desc:"Modern Indo Western set blending kurta and pants in premium black fabric."},
  {id:23,code:"IW02GR",name:"Green Indo Western Co-ord Set",cat:"Indo Western Sets",price:21900,sizes:["S","M","L","XL"],imgs:imgUrls("IW02GR",5),desc:"Fresh green Indo Western set — vibrant and contemporary."},
  {id:24,code:"IW03DB",name:"Dark Blue Indo Western Co-ord Set",cat:"Indo Western Sets",price:21900,sizes:["S","M","L","XL"],imgs:imgUrls("IW03DB",7),desc:"Deep blue Indo Western — refined and versatile."},
  {id:25,code:"IW05WI",name:"Wine Indo Western Set",cat:"Indo Western Sets",price:19900,sizes:["S","M","L","XL","XXL"],imgs:imgUrls("IW05WI",8),desc:"Breathable wine Indo Western set — effortless and elegant."},
  {id:26,code:"IW06BL",name:"Black Printed Indo Western Set",cat:"Indo Western Sets",price:19900,sizes:["M","L","XL"],imgs:imgUrls("IW06BL",8),desc:"Contemporary black with block print detailing."},
  {id:27,code:"IW07DB",name:"Dark Blue Printed Indo Western Set",cat:"Indo Western Sets",price:19900,sizes:["M","L","XL"],imgs:imgUrls("IW07DB",8),desc:"Dark blue Indo Western with modern print. Perfect for daytime events."},
  {id:28,code:"IW09PC",name:"Peach Indo Western Set",cat:"Indo Western Sets",price:18500,sizes:["S","M","L","XL"],imgs:imgUrls("IW09PC",5),desc:"Soft peach Indo Western — light and festive."},
